...
sudo xbps-install -S sway swaylock swayidle swaybg alacritty Waybar font-awesome fastfetch wofi rofi curl libreoffice-writer libreoffice-calc libreoffice-impress libreoffice-gnome libreoffice-fonts flatpak NetworkManager network-manager-applet iwd bleachbit pavucontrol gvfs gvfs-mtp nwg-look dunst polkit-gnome btop gcc qimgv zip unzip 7zip tar Thunar thunar-archive-plugin thunar-volman tumbler mpv xarchiver geany cmus upower qbittorrent grim slurp neovim xorg-server-xwayland xdg-desktop-portal-wlr zathura zathura-cb zathura-pdf-poppler noto-fonts-ttf noto-fonts-emoji noto-fonts-cjk elogind dbus polkit steam unrar brillo mesa pulseaudio pulseaudio-utils libgcc-32bit libstdc++-32bit libdrm-32bit libglvnd-32bit ffmpeg lf fzf opendoas mesa-dri-32bit alsa-plugins-pulseaudio vulkan-loader mesa-vulkan-radeon mesa-vaapi mesa-vdpau mesa-vulkan-radeon-32bit vulkan-loader-32bit groff bc yt-dlp make xhost fonts-roboto-ttf ttf-ubuntu-font-family
